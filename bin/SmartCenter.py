    ...
    def detect_lane(self, frame):
        ...
        if left_contours and right_contours:
            ...
            if left_M["m00"] > 0 and right_M["m00"] > 0:
                ...
                # Calcular o ponto central entre as duas linhas
                ...
                # Linha central em verde
                cv2.line(vis_mask, (center_x, roi_y_start), (center_x, height), (0, 255, 0), 2)
...
class UnityBridge:
        ...
        while self.running:
            try:
                ...
                if deviation is not None:
                    ...
                    base_speed_normalized = self.car_config.base_speed / 4.0  # Assuming max speed was around 10
                    ...
                    cv2.putText(frame, "Linha perdida - Parando", (10, 30),
    ...
    def _draw_visualization(self, frame, deviation, steering_angle, speed):
        ...
        cv2.putText(frame, f"Angulo: {steering_angle}", (10, 60), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        cv2.putText(frame, f"Velocidade: {speed:.1f}", (10, 90), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
    ...
    def close(self):
        """Encerra recursos e threads"""
        logger.info("Encerrando comunicação com Unity")
        self.running = False
        try:
            # Envia comando de parada antes de encerrar
            self.send_command(0, 0)
